...
/** STB Truetype demo. */
public final class Main extends FontDemo {
    ...
    private Main(String filePath) {
        super(24, filePath, "Test");

        try {
            ttf = ioResourceToByteBuffer(filePath, 512 * 1024);
        } catch (IOException e) {
    ...
    public static void main(String[] args) {
        String filePath = new String("src/assets/fonts/yuji-syuku-japanese-400-normal.ttf");

        new Main(filePath).run("STB Truetype Demo");
    }
